        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              required
              disabled={loading}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-900 placeholder:text-gray-500 bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"
            />
          </div>
