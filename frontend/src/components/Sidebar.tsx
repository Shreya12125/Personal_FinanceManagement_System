...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`w-64 bg-gray-900 text-white h-screen flex flex-col flex-shrink-0 transition-all duration-300 ease-in-out ${isOpen ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0 absolute'
          }`}
      >
